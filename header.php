		...
		<div>
			<?php if(!is_singular('movie')):?>
				...
				<svg width="405" height="286" class="lines" viewBox="0 0 405 286" fill="none" xmlns="http://www.w3.org/2000/svg">
					<rect x="287" y="123.551" width="162" height="4" rx="2" transform="rotate(-45 287 123.551)" fill="#01D277" fill-opacity="0.83"/>
					<rect x="276" y="159.551" width="162" height="4" rx="2" transform="rotate(-45 276 159.551)" fill="#01D277" fill-opacity="0.83"/>
					<rect x="249" y="282.551" width="162" height="4" rx="2" transform="rotate(-45 249 282.551)" fill="#01D277" fill-opacity="0.83"/>
					<rect y="276.551" width="162" height="4" rx="2" transform="rotate(-45 0 276.551)" fill="#01D277" fill-opacity="0.83"/>
					<rect x="31" y="141.551" width="162" height="4" rx="2" transform="rotate(-45 31 141.551)" fill="#01D277" fill-opacity="0.83"/>
